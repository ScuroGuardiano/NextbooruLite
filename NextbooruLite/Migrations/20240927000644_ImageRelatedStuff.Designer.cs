...
namespace NextbooruLite.Migrations
{
    ...
    [Migration("20240927000644_ImageRelatedStuff")]
    partial class ImageRelatedStuff
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NextbooruLite.Model.Album", b =>
                {
                    ...
                    b.HasIndex("CreatedById")
                        .HasDatabaseName("ix_album_created_by_id");
            ...
            modelBuilder.Entity("NextbooruLite.Model.Image", b =>
                {
                    ...
                    b.HasIndex("TagsArr")
                        .HasDatabaseName("ix_image_tags_arr");

                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("TagsArr"), "GIN");

                    b.HasIndex("UploadedById")
                        .HasDatabaseName("ix_image_uploaded_by_id");
            ...
            modelBuilder.Entity("NextbooruLite.Model.ImageVariant", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_image_variant");

                    b.HasIndex("ImageId")
                        .HasDatabaseName("ix_image_variant_image_id");

                    b.ToTable("image_variant", (string)null);
                });
            ...
            modelBuilder.Entity("AlbumImage", b =>
                {
                    b.HasOne("NextbooruLite.Model.Album", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_album_image_album_albums_id");
                    ...
                    b.HasOne("NextbooruLite.Model.Image", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_album_image_image_images_id");
                });
            ...
            modelBuilder.Entity("ImageTag", b =>
                {
                    b.HasOne("NextbooruLite.Model.Image", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_image_tag_image_images_id");
                    ...
                    b.HasOne("NextbooruLite.Model.Tag", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_image_tag_tag_tags_id");
                });
            ...
            modelBuilder.Entity("NextbooruLite.Model.Album", b =>
                {
                    b.HasOne("NextbooruLite.Auth.Model.User", "CreatedBy")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_album_users_created_by_id");
            ...
            modelBuilder.Entity("NextbooruLite.Model.Image", b =>
                {
                    b.HasOne("NextbooruLite.Auth.Model.User", "UploadedBy")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_image_users_uploaded_by_id");
            ...
            modelBuilder.Entity("NextbooruLite.Model.ImageVariant", b =>
                {
                    b.HasOne("NextbooruLite.Model.Image", "Image")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_image_variant_image_image_id");
